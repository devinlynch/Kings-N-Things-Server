...
public class scripttest {
	...
	public void testRunThroughGame() throws Exception{
		...
		pPhase.didPlaceControlMarkers("player1", "hexLocation_2", "hexLocation_9", "hexLocation_23");
		pPhase.didPlaceControlMarkers("player2", "hexLocation_26", "hexLocation_12", "hexLocation_28");
		pPhase.didPlaceControlMarkers("player3", "hexLocation_15", "hexLocation_16", "hexLocation_32");
		pPhase.didPlaceControlMarkers("player4", "hexLocation_19", "hexLocation_18", "hexLocation_7");
		
		assertEquals("player1", gs.getHexLocationsById("hexLocation_2").getOwner().getPlayerId());
		assertEquals("player2", gs.getHexLocationsById("hexLocation_26").getOwner().getPlayerId());
		assertEquals("player3", gs.getHexLocationsById("hexLocation_15").getOwner().getPlayerId());
		assertEquals("player4", gs.getHexLocationsById("hexLocation_19").getOwner().getPlayerId());
		...
		pPhase.didPlaceFort("player1", fort1.getId(), "hexLocation_2");
		assertEquals("hexLocation_2", fort1.getLocation().getId());
		...
		pPhase.didPlaceFort("player2", fort2.getId(), "hexLocation_12");
		assertEquals("hexLocation_12", fort2.getLocation().getId());
		...
		pPhase.didPlaceFort("player3", fort3.getId(), "hexLocation_15");
		assertEquals("hexLocation_15", fort3.getLocation().getId());
		...
		pPhase.didPlaceFort("player4", fort4.getId(), "hexLocation_7");
		assertEquals("hexLocation_7", fort4.getLocation().getId());
		...
		rtPhase.didRecruitAndPlaceThing("player1", "T_Mountains_050-01", "player1_rack2", true);
		...
		//mPhase.didMoveGamePiece(p1.getPlayerId(), gs.getHexLocationsById("frozen-tile-02"), "T_Mountains_050-01");
